...
# ==== Step 1. Setup shadow ====
folderPath = "./certificates/q3_second_engine/"
...
PRIVATE_KEY = folderPath + "f7298754b1-private.pem.key"

# The relative path to your certificate file that 
# &IoT; generated for this device, which you 
# have already saved onto this device.
CERT_FILE = folderPath + "f7298754b1-certificate.pem.crt.txt"

# A programmatic shadow handler name prefix.
SHADOW_HANDLER = "EE5111_A0039875M_JetEngine2"
...
data = pd.read_csv("./input/train_FD002.txt", delimiter=' ', names=names, usecols=names[:-2])
data['id'] = list(map(lambda s: 'FD002_'+str(s), data['id']))         # modifiy id
